...
@section('content')
    ...
    <section id="slider-part" class="slider-active">
        <div class="single-slider slider-2 bg_cover" style="background-image: url({{ asset('storage/frontEnd/slider/s-2.jpg') }})" data-overlay="4">
            <div class="container">
                <div class="row">
        ...
        <div class="single-slider slider-2 bg_cover" style="background-image: url({{ asset('storage/frontEnd/slider/s-3.jpg') }})" data-overlay="4">
            <div class="container">
                <div class="row">
                    <div class="col-xl-9 col-lg-10">
                        <div class="slider-cont">
        ...
        <div class="single-slider slider-2 bg_cover" style="background-image: url({{ asset('storage/frontEnd/slider/s-1.jpg') }})" data-overlay="4">
            <div class="container">
                <div class="row">
                    <div class="col-xl-9 col-lg-10">
                        <div class="slider-cont">
                    ...
                    <div class="category-2-items pt-10">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="singel-items text-center mt-30">
                                    <div class="items-image">
                                        <img src="{{ asset('storage/frontEnd/category/ctg-1.jpg') }}" alt="Category">
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="singel-items text-center mt-30">
                                    <div class="items-image">
                                        <img src="{{ asset('storage/frontEnd/category/ctg-2.jpg') }}" alt="Category">
                                    </div>
                                    <div class="items-cont">
                                        <a href="#">
                            ...
                            <div class="col-md-6">
                                <div class="singel-items text-center mt-30">
                                    <div class="items-image">
                                        <img src="{{ asset('storage/frontEnd/category/ctg-3.jpg') }}" alt="Category">
                                    </div>
                                    <div class="items-cont">
                                        <a href="#">
                                            <h5>UI/ UX Design</h5>
                            ...
                            <div class="col-md-6">
                                <div class="singel-items text-center mt-30">
                                    <div class="items-image">
                                        <img src="{{ asset('storage/frontEnd/category/ctg-4.jpg') }}" alt="Category">
                                    </div>
                                    <div class="items-cont">
                                        <a href="#">
                                            <h5>Photography</h5>
                            ...
                            <div class="col-md-6">
                                <div class="singel-items text-center mt-30">
                                    <div class="items-image">
                                        <img src="{{ asset('storage/frontEnd/category/ctg-5.jpg') }}" alt="Category">
                                    </div>
                                    <div class="items-cont">
                                        <a href="#">
                                            <h5>Finance</h5>
                            ...
                            <div class="col-md-6">
                                <div class="singel-items text-center mt-30">
                                    <div class="items-image">
                                        <img src="{{ asset('storage/frontEnd/category/ctg-6.jpg') }}" alt="Category">
                                    </div>
                                    <div class="items-cont">
                                        <a href="#">
                                            <h5>Science</h5>
            ...
            <div class="row course-slied mt-30">
                <div class="col-lg-4">
                    <div class="singel-course-2">
                        <div class="thum">
                            <div class="image">
                                <img src="{{ asset('storage/frontEnd/course/cu-1.jpg') }}" alt="Course">
                            </div>
                            <div class="price">
                                <span>Free</span>
                            </div>
                            <div class="course-teacher">
                                <div class="thum">
                                    <a href="courses-singel.html"><img src="{{ asset('storage/frontEnd/course/teacher/t-1.jpg') }}" alt="teacher"></a>
                                </div>
                                <div class="name">
                ...
                <div class="col-lg-4">
                    <div class="singel-course-2">
                        <div class="thum">
                            <div class="image">
                                <img src="{{ asset('storage/frontEnd/course/cu-2.jpg') }}" alt="Course">
                            </div>
                            <div class="price">
                                <span>Free</span>
                            </div>
                            <div class="course-teacher">
                                <div class="thum">
                                    <a href="courses-singel.html"><img src="{{ asset('storage/frontEnd/course/teacher/t-2.jpg') }}" alt="teacher"></a>
                                </div>
                                <div class="name">
                                    <a href="#"><h6>Mark anthem</h6></a>
                                </div>
                ...
                <div class="col-lg-4">
                    <div class="singel-course-2">
                        <div class="thum">
                            <div class="image">
                                <img src="{{ asset('storage/frontEnd/course/cu-3.jpg') }}" alt="Course">
                            </div>
                            <div class="price">
                                <span>Free</span>
                            </div>
                            <div class="course-teacher">
                                <div class="thum">
                                    <a href="courses-singel.html"><img src="{{ asset('storage/frontEnd/course/teacher/t-3.jpg') }}" alt="teacher"></a>
                                </div>
                                <div class="name">
                                    <a href="#"><h6>Mark anthem</h6></a>
                                </div>
                ...
                <div class="col-lg-4">
                    <div class="singel-course-2">
                        <div class="thum">
                            <div class="image">
                                <img src="{{ asset('storage/frontEnd/course/cu-4.jpg') }}" alt="Course">
                            </div>
                            <div class="price">
                                <span>Free</span>
                            </div>
                            <div class="course-teacher">
                                <div class="thum">
                                    <a href="courses-singel.html"><img src="{{ asset('storage/frontEnd/course/teacher/t-4.jpg') }}" alt="teacher"></a>
                                </div>
                                <div class="name">
                                    <a href="#"><h6>Mark anthem</h6></a>
                                </div>
                ...
                <div class="col-lg-4">
                    <div class="singel-course-2">
                        <div class="thum">
                            <div class="image">
                                <img src="{{ asset('storage/frontEnd/course/cu-5.jpg') }}" alt="Course">
                            </div>
                            <div class="price">
                                <span>Free</span>
                            </div>
                            <div class="course-teacher">
                                <div class="thum">
                                    <a href="courses-singel.html"><img src="{{ asset('storage/frontEnd/course/teacher/t-5.jpg') }}" alt="teacher"></a>
                                </div>
                                <div class="name">
                                    <a href="#"><h6>Mark anthem</h6></a>
                                </div>
    ...
    <div id="counter-part" class="bg_cover pt-65 pb-110" data-overlay="8" style="background-image: url({{ asset('storage/frontEnd/bg-2.jpg') }})">
        <div class="container">
            <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="teachers-2-singel mt-30">
                                    <div class="thum">
                                        <img src="{{ asset('storage/frontEnd/teachers/teacher-2/tc-1.jpg') }}" alt="Teacher">
                                    </div>
                                    <div class="cont">
                            ...
                            <div class="col-md-6">
                                <div class="teachers-2-singel mt-30">
                                    <div class="thum">
                                        <img src="{{ asset('storage/frontEnd/teachers/teacher-2/tc-2.jpg') }}" alt="Teacher">
                                    </div>
                                    <div class="cont">
                    ...
                    <div class="happy-student mt-55">
                        ...
                        <div class="student-slied">
                            <div class="singel-student">
                                <img src="{{ asset('storage/frontEnd/teachers/teacher-2/quote.png') }}" alt="Quote">
                        ...
                        <div class="student-image">
                            <img src="{{ asset('storage/frontEnd/teachers/teacher-2/happy.png') }}" alt="Image">
                        </div>
                    </div> <!-- happy student -->
                </div>
            </div> <!-- row -->
    ...
    <section id="event-part" class="pt-120">
        <div class="container">
            <div class="event-bg bg_cover" style="background-image: url({{ asset('storage/frontEnd/bg-3.jpg') }})">
                <div class="row">
            ...
            <div class="row patnar-slied">
                <div class="col-lg-12">
                    <div class="singel-patnar text-center mt-40">
                        <img src="{{ asset('storage/frontEnd/patnar-logo/p-1.png') }}" alt="Logo">
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="singel-patnar text-center mt-40">
                        <img src="{{ asset('storage/frontEnd/patnar-logo/p-2.png') }}" alt="Logo">
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="singel-patnar text-center mt-40">
                        <img src="{{ asset('storage/frontEnd/patnar-logo/p-3.png') }}" alt="Logo">
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="singel-patnar text-center mt-40">
                        <img src="{{ asset('storage/frontEnd/patnar-logo/p-4.png') }}" alt="Logo">
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="singel-patnar text-center mt-40">
